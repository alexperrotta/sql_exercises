...
-- 7. List all albums along with its total duration based on summing the duration of its tracks. 8. What is the album with the longest duration?
-- 9. Who are the 5 most prolific artists based on the number of albums they have recorded?
-- 10. What are all the tracks a given artist has recorded? 11. What are the top 5 most often recorded songs?
-- 12. Who are the top 5 song writers whose songs have been most often recorded?
-- 13. Who is the most prolific song writer based on the number of songs he has written? 14. What songs has a given artist recorded?
